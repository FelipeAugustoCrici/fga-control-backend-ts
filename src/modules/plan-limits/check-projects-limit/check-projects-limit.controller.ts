...
// GET /api/v1/plans/limits/check/projects?current=N — réplica de
// PlanLimitHandler.CheckProjectsLimit. Sem envelope {data: ...}.
@Controller('api/v1/plans/limits/check/projects')
export class CheckProjectsLimitController {
